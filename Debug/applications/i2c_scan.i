...
# 8 "../applications/i2c_scan.c" 2

int i2c_scan(int argc, char *argv[])
{
    struct rt_i2c_bus_device *dev = 0;
...
const char __fsym_i2c_scan_name[] __attribute__((section(".rodata.name"))) = "i2c_scan"; const char __fsym_i2c_scan_desc[] __attribute__((section(".rodata.name"))) = "i2c scan"; __attribute__((used)) const struct finsh_syscall __fsym_i2c_scan __attribute__((section("FSymTab")))= { __fsym_i2c_scan_name, __fsym_i2c_scan_desc, (syscall_func)&i2c_scan };;
