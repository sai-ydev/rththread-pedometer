# 1 "../applications/bmi270/bmi270_legacy.c"
...
# 1 "<command-line>" 2
# 1 "../applications/bmi270/bmi270_legacy.c"
# 1 "C:\\Users\\yaman\\OneDrive\\Documents\\rtthread-workspace\\CH32V208\\applications/bmi270/bmi270_legacy.h" 1
# 49 "C:\\Users\\yaman\\OneDrive\\Documents\\rtthread-workspace\\CH32V208\\applications/bmi270/bmi270_legacy.h"
#define BMI270_LEGACY_H_ 
# 60 "C:\\Users\\yaman\\OneDrive\\Documents\\rtthread-workspace\\CH32V208\\applications/bmi270/bmi270_legacy.h"
...
# 61 "C:\\Users\\yaman\\OneDrive\\Documents\\rtthread-workspace\\CH32V208\\applications/bmi270/bmi270_legacy.h" 2
...
# 179 "C:\\Users\\yaman\\OneDrive\\Documents\\rtthread-workspace\\CH32V208\\applications/bmi270/bmi270_legacy.h"
int8_t bmi270_legacy_init(struct bmi2_dev *dev);
# 232 "C:\\Users\\yaman\\OneDrive\\Documents\\rtthread-workspace\\CH32V208\\applications/bmi270/bmi270_legacy.h"
int8_t bmi270_legacy_sensor_enable(const uint8_t *sens_list, uint8_t n_sens, struct bmi2_dev *dev);
# 279 "C:\\Users\\yaman\\OneDrive\\Documents\\rtthread-workspace\\CH32V208\\applications/bmi270/bmi270_legacy.h"
int8_t bmi270_legacy_sensor_disable(const uint8_t *sens_list, uint8_t n_sens, struct bmi2_dev *dev);
# 321 "C:\\Users\\yaman\\OneDrive\\Documents\\rtthread-workspace\\CH32V208\\applications/bmi270/bmi270_legacy.h"
int8_t bmi270_legacy_set_sensor_config(struct bmi2_sens_config *sens_cfg, uint8_t n_sens, struct bmi2_dev *dev);
# 357 "C:\\Users\\yaman\\OneDrive\\Documents\\rtthread-workspace\\CH32V208\\applications/bmi270/bmi270_legacy.h"
int8_t bmi270_legacy_get_sensor_config(struct bmi2_sens_config *sens_cfg, uint8_t n_sens, struct bmi2_dev *dev);
# 394 "C:\\Users\\yaman\\OneDrive\\Documents\\rtthread-workspace\\CH32V208\\applications/bmi270/bmi270_legacy.h"
int8_t bmi270_legacy_get_feature_data(struct bmi2_feat_sensor_data *feature_data, uint8_t n_sens, struct bmi2_dev *dev);
# 417 "C:\\Users\\yaman\\OneDrive\\Documents\\rtthread-workspace\\CH32V208\\applications/bmi270/bmi270_legacy.h"
int8_t bmi270_legacy_update_gyro_user_gain(const struct bmi2_gyro_user_gain_config *user_gain, struct bmi2_dev *dev);
# 434 "C:\\Users\\yaman\\OneDrive\\Documents\\rtthread-workspace\\CH32V208\\applications/bmi270/bmi270_legacy.h"
int8_t bmi270_legacy_read_gyro_user_gain(struct bmi2_gyro_user_gain_data *gyr_usr_gain, struct bmi2_dev *dev);
# 452 "C:\\Users\\yaman\\OneDrive\\Documents\\rtthread-workspace\\CH32V208\\applications/bmi270/bmi270_legacy.h"
int8_t bmi270_legacy_map_feat_int(const struct bmi2_sens_int_config *sens_int, uint8_t n_sens, struct bmi2_dev *dev);
# 2 "../applications/bmi270/bmi270_legacy.c" 2
# 52 "../applications/bmi270/bmi270_legacy.c"
...
int8_t bmi270_legacy_sensor_enable(const uint8_t *sens_list, uint8_t n_sens, struct bmi2_dev *dev)
{
    ...
    rslt = null_ptr_check(dev);
    if ((rslt == 0) && (sens_list != 
# 1930 "../applications/bmi270/bmi270_legacy.c" 3 4
                                          ((void *)0)
# 1930 "../applications/bmi270/bmi270_legacy.c"
                                              ))
    {
...
int8_t bmi270_legacy_sensor_disable(const uint8_t *sens_list, uint8_t n_sens, struct bmi2_dev *dev)
{
    ...
    rslt = null_ptr_check(dev);
    if ((rslt == 0) && (sens_list != 
# 1961 "../applications/bmi270/bmi270_legacy.c" 3 4
                                          ((void *)0)
# 1961 "../applications/bmi270/bmi270_legacy.c"
                                              ))
    {
...
int8_t bmi270_legacy_set_sensor_config(struct bmi2_sens_config *sens_cfg, uint8_t n_sens, struct bmi2_dev *dev)
{
    ...
    rslt = null_ptr_check(dev);
    if ((rslt == 0) && (sens_cfg != 
# 1995 "../applications/bmi270/bmi270_legacy.c" 3 4
                                         ((void *)0)
# 1995 "../applications/bmi270/bmi270_legacy.c"
                                             ))
    {
        ...
        {
            if ((sens_cfg[loop].type == 0) || (sens_cfg[loop].type == 1) ||
                (sens_cfg[loop].type == 2) || (sens_cfg[loop].type == 9))
            {
...
int8_t bmi270_legacy_get_sensor_config(struct bmi2_sens_config *sens_cfg, uint8_t n_sens, struct bmi2_dev *dev)
{
    ...
    rslt = null_ptr_check(dev);
    if ((rslt == 0) && (sens_cfg != 
# 2064 "../applications/bmi270/bmi270_legacy.c" 3 4
                                         ((void *)0)
# 2064 "../applications/bmi270/bmi270_legacy.c"
                                             ))
    {
...
int8_t bmi270_legacy_get_feature_data(struct bmi2_feat_sensor_data *feature_data, uint8_t n_sens, struct bmi2_dev *dev)
{
    ...
    rslt = null_ptr_check(dev);
    if ((rslt == 0) && (feature_data != 
# 2136 "../applications/bmi270/bmi270_legacy.c" 3 4
                                             ((void *)0)
# 2136 "../applications/bmi270/bmi270_legacy.c"
                                                 ))
    {
        ...
        for (loop = 0; loop < n_sens; loop++)
        {
            if ((feature_data[loop].type == 9) ||
                (feature_data[loop].type == 41))
            {
...
int8_t bmi270_legacy_update_gyro_user_gain(const struct bmi2_gyro_user_gain_config *user_gain, struct bmi2_dev *dev)
{
    ...
    rslt = null_ptr_check(dev);
    if ((rslt == 0) && (user_gain != 
# 2255 "../applications/bmi270/bmi270_legacy.c" 3 4
                                          ((void *)0)
# 2255 "../applications/bmi270/bmi270_legacy.c"
                                              ))
    {
        ...
        if (rslt == 0)
        {
            rslt = bmi2_set_command_register(0x03, dev);
        }
...
int8_t bmi270_legacy_read_gyro_user_gain(struct bmi2_gyro_user_gain_data *gyr_usr_gain, struct bmi2_dev *dev)
{
    ...
    rslt = null_ptr_check(dev);
    if ((rslt == 0) && (gyr_usr_gain != 
# 2342 "../applications/bmi270/bmi270_legacy.c" 3 4
                                             ((void *)0)
# 2342 "../applications/bmi270/bmi270_legacy.c"
                                                 ))
    {

        rslt = bmi2_get_regs(0x78, reg_data, 3, dev);
        if (rslt == 0)
        {

            gyr_usr_gain->x = (int8_t)(reg_data[0] & (0x7F));


            gyr_usr_gain->y = (int8_t)(reg_data[1] & (0x7F));


            gyr_usr_gain->z = (int8_t)(reg_data[2] & (0x7F));
        }
    }
    else
    {
...
int8_t bmi270_legacy_map_feat_int(const struct bmi2_sens_int_config *sens_int, uint8_t n_sens, struct bmi2_dev *dev)
{
    ...
    rslt = null_ptr_check(dev);
    if ((rslt == 0) && (sens_int != 
# 2379 "../applications/bmi270/bmi270_legacy.c" 3 4
                                         ((void *)0)
# 2379 "../applications/bmi270/bmi270_legacy.c"
                                             ))
    {
        for (loop = 0; loop < n_sens; loop++)
        {
...
# 2427 "../applications/bmi270/bmi270_legacy.c"
static int8_t get_tap_config(void *tap, void *bmi2_dev)
{
...
static int8_t get_config_page_primary(void *tap, void *bmi2_dev)
{
    ...
    feat_found = bmi2_extract_input_feat_config(&tap_config, 30, dev);
    ...
    if (feat_found == 1)
    {
        ...
        if (rslt == 0)
        {
            ...
            bmi270_legacy_config->data_reg_en = (lsb_msb & 0x08) >> 0x03;
...
static int8_t get_config_page_secondary(void *tap, void *bmi2_dev)
{
    ...
    feat_found = bmi2_extract_input_feat_config(&tap_config, 31, dev);
    ...
    if (feat_found == 1)
    {
        ...
        if (rslt == 0)
        {
            ...
            bmi270_legacy_config->axis_sel = (lsb_msb & 0x03);
        }
    }
    else
    {
...
static int8_t set_config_page_primary(void *tap, void *bmi2_dev)
{
    ...
    if (feat_found == 1)
    {
        ...
        if (rslt == 0)
        {
            ...
            *(data_p + idx) = ((*(data_p + idx) & ~(0x08)) | ((bmi270_legacy_config->data_reg_en << 0x03) & 0x08));
...
static int8_t set_config_page_secondary(void *tap, void *bmi2_dev)
{
    ...
    if (feat_found == 1)
    {
        ...
        if (rslt == 0)
        {
            ...
            *(data_p + idx) = ((*(data_p + idx) & ~(0x03)) | (bmi270_legacy_config->axis_sel & 0x03));
...
static int8_t null_ptr_check(const struct bmi2_dev *dev)
{
    ...
    if ((dev == 
# 2812 "../applications/bmi270/bmi270_legacy.c" 3 4
               ((void *)0)
# 2812 "../applications/bmi270/bmi270_legacy.c"
                   ) || (dev->read == 
# 2812 "../applications/bmi270/bmi270_legacy.c" 3 4
                                      ((void *)0)
# 2812 "../applications/bmi270/bmi270_legacy.c"
...
static int8_t select_sensor(const uint8_t *sens_list, uint8_t n_sens, uint64_t *sensor_sel)
{
    ...
    {
        if (sens_list[count] == 0)
        {
            *sensor_sel |= (1);
            count++;
        }

        if (sens_list[count] == 1)
        {
            *sensor_sel |= (1 << 1);
            count++;
        }

        if (sens_list[count] == 2)
        {
            *sensor_sel |= (1 << 2);
            count++;
        }

        if (sens_list[count] == 32)
        {
...
static int8_t sensor_enable(uint64_t sensor_sel, struct bmi2_dev *dev)
{
    ...
    if ((rslt == 0) && (sensor_sel & ~(((1) | (1 << 1) | (1 << 2) | ((uint64_t)1 << 32)))))
    {
...
static int8_t set_any_motion(uint8_t enable, struct bmi2_dev *dev)
{
    ...
    feat_found = bmi2_extract_input_feat_config(&any_mot_config, 4, dev);
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            idx = any_mot_config.start_addr + 0x03;


            feat_config[idx] = ((feat_config[idx] & ~(0x80)) | ((enable << 0x07) & 0x80));
...
static int8_t set_no_motion(uint8_t enable, struct bmi2_dev *dev)
{
    ...
    feat_found = bmi2_extract_input_feat_config(&no_mot_config, 5, dev);
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            idx = no_mot_config.start_addr + 0x03;
...
static int8_t set_step_detector(uint8_t enable, struct bmi2_dev *dev)
{
    ...
    feat_found = bmi2_extract_input_feat_config(&step_det_config, 6, dev);
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            idx = step_det_config.start_addr + 0x01;


            feat_config[idx] = ((feat_config[idx] & ~(0x08)) | ((enable << 0x03) & 0x08));
...
static int8_t set_step_counter(uint8_t enable, struct bmi2_dev *dev)
{
    ...
    feat_found = bmi2_extract_input_feat_config(&step_count_config, 7, dev);
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            idx = step_count_config.start_addr + 0x01;


            feat_config[idx] = ((feat_config[idx] & ~(0x10)) | ((enable << 0x04) & 0x10));
...
static int8_t set_step_activity(uint8_t enable, struct bmi2_dev *dev)
{
    ...
    feat_found = bmi2_extract_input_feat_config(&step_act_config, 8, dev);
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            idx = step_act_config.start_addr + 0x01;


            feat_config[idx] = ((feat_config[idx] & ~(0x20)) | ((enable << 0x05) & 0x20));
...
static int8_t set_sig_motion(uint8_t enable, struct bmi2_dev *dev)
{
    ...
    feat_found = bmi2_extract_input_feat_config(&sig_mot_config, 3, dev);
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            idx = sig_mot_config.start_addr + 0x0A;


            feat_config[idx] = ((feat_config[idx] & ~(0x01)) | (enable & 0x01));
...
static int8_t set_single_tap(uint8_t enable, struct bmi2_dev *dev)
{
    ...
    feat_found = bmi2_extract_input_feat_config(&tap_config, 25, dev);
    if (feat_found)
    {
...
static int8_t set_double_tap(uint8_t enable, struct bmi2_dev *dev)
{
    ...
    feat_found = bmi2_extract_input_feat_config(&tap_config, 26, dev);
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            feat_config[idx] = ((feat_config[idx] & ~(0x02)) | ((enable << 0x01) & 0x02));
...
static int8_t set_triple_tap(uint8_t enable, struct bmi2_dev *dev)
{
    ...
    feat_found = bmi2_extract_input_feat_config(&tap_config, 27, dev);
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            feat_config[idx] = ((feat_config[idx] & ~(0x04)) | ((enable << 0x02) & 0x04));
...
static int8_t set_orientation(uint8_t enable, struct bmi2_dev *dev)
{
    ...
    feat_found = bmi2_extract_input_feat_config(&orient_config, 14, dev);
    if (feat_found)
    {
...
static int8_t set_high_g(uint8_t enable, struct bmi2_dev *dev)
{
    ...
    feat_found = bmi2_extract_input_feat_config(&high_g_config, 15, dev);
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            idx = high_g_config.start_addr + 0x03;
...
static int8_t set_low_g(uint8_t enable, struct bmi2_dev *dev)
{
    ...
    feat_found = bmi2_extract_input_feat_config(&low_g_config, 16, dev);
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            idx = low_g_config.start_addr + 0x03;
...
static int8_t set_flat(uint8_t enable, struct bmi2_dev *dev)
{
    ...
    feat_found = bmi2_extract_input_feat_config(&flat_config, 17, dev);
    if (feat_found)
    {
...
static int8_t set_gyro_self_offset_corr(uint8_t enable, struct bmi2_dev *dev)
{
    ...
    feat_found = bmi2_extract_input_feat_config(&self_off_corr_cfg, 34, dev);
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            if ((rslt == 0) && (enable == 1))
            {
                dev->sens_en_stat |= ((uint64_t)1 << 34);
            }
            else
            {
                dev->sens_en_stat &= ~((uint64_t)1 << 34);
...
static int8_t set_gyro_user_gain(uint8_t enable, struct bmi2_dev *dev)
{
    ...
    feat_found = bmi2_extract_input_feat_config(&gyr_user_gain_cfg, 9, dev);
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            idx = gyr_user_gain_cfg.start_addr + 0x05;
...
static int8_t set_any_motion_config(const struct bmi2_any_motion_config *config, struct bmi2_dev *dev)
{
    ...
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            *(data_p + idx) = ((*(data_p + idx) & ~(0x1FFF)) | (config->duration & 0x1FFF));


            *(data_p + idx) = ((*(data_p + idx) & ~(0x2000)) | ((config->select_x << 0x0D) & 0x2000));


            *(data_p + idx) = ((*(data_p + idx) & ~(0x4000)) | ((config->select_y << 0x0E) & 0x4000));


            *(data_p + idx) = ((*(data_p + idx) & ~(0x8000)) | ((config->select_z << 0x0F) & 0x8000));


            idx++;


            *(data_p + idx) = ((*(data_p + idx) & ~(0x07FF)) | (config->threshold & 0x07FF));
...
static int8_t set_sig_motion_config(const struct bmi2_sig_motion_config *config, struct bmi2_dev *dev)
{
    ...
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            *(data_p + idx) = ((*(data_p + idx) & ~(0xFFFF)) | (config->block_size & 0xFFFF));
...
static int8_t set_step_config(const struct bmi2_step_config *config, struct bmi2_dev *dev)
{
    ...
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            *(data_p + idx) = ((*(data_p + idx) & ~(0x03FF)) | (config->watermark_level & 0x03FF));


            *(data_p + idx) = ((*(data_p + idx) & ~(0x0400)) | ((config->reset_counter << 0x0A) & 0x0400));
            ...
            *(data_p + idx) = ((*(data_p + idx) & ~(0xFF00)) | ((config->step_buffer_size << 0x08) & 0xFF00));
...
static int8_t set_orient_config(const struct bmi2_orient_config *config, struct bmi2_dev *dev)
{
    ...
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            *(data_p + idx) = ((*(data_p + idx) & ~(0x0002)) | ((config->ud_en << 0x01) & 0x0002));


            *(data_p + idx) = ((*(data_p + idx) & ~(0x000C)) | ((config->mode << 0x02) & 0x000C));


            *(data_p + idx) = ((*(data_p + idx) & ~(0x0030)) | ((config->blocking << 0x04) & 0x0030));


            *(data_p + idx) = ((*(data_p + idx) & ~(0x0FC0)) | ((config->theta << 0x06) & 0x0FC0));


            idx++;


            *(data_p + idx) = ((*(data_p + idx) & ~(0x07FF)) | (config->hysteresis & 0x07FF));
...
static int8_t set_high_g_config(const struct bmi2_high_g_config *config, struct bmi2_dev *dev)
{
    ...
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            *(data_p + idx) = ((*(data_p + idx) & ~(0x7FFF)) | (config->threshold & 0x7FFF));


            idx++;


            *(data_p + idx) = ((*(data_p + idx) & ~(0x0FFF)) | (config->hysteresis & 0x0FFF));


            *(data_p + idx) = ((*(data_p + idx) & ~(0x1000)) | ((config->select_x << 0x0C) & 0x1000));


            *(data_p + idx) = ((*(data_p + idx) & ~(0x2000)) | ((config->select_y << 0x0D) & 0x2000));


            *(data_p + idx) = ((*(data_p + idx) & ~(0x4000)) | ((config->select_z << 0x0E) & 0x4000));


            idx++;


            *(data_p + idx) = ((*(data_p + idx) & ~(0x0FFF)) | (config->duration & 0x0FFF));
...
static int8_t set_flat_config(const struct bmi2_flat_config *config, struct bmi2_dev *dev)
{
    ...
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            *(data_p + idx) = ((*(data_p + idx) & ~(0x007E)) | ((config->theta << 0x01) & 0x007E));


            *(data_p + idx) = ((*(data_p + idx) & ~(0x0180)) | ((config->blocking << 0x07) & 0x0180));


            idx++;


            *(data_p + idx) = ((*(data_p + idx) & ~(0x003F)) | (config->hysteresis & 0x003F));


            *(data_p + idx) = ((*(data_p + idx) & ~(0x3FC0)) | ((config->hold_time << 0x06) & 0x3FC0));
...
static int8_t get_any_motion_config(struct bmi2_any_motion_config *config, struct bmi2_dev *dev)
{
    ...
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            config->duration = lsb_msb & 0x1FFF;


            config->select_x = (lsb_msb & 0x2000) >> 0x0D;


            config->select_y = (lsb_msb & 0x4000) >> 0x0E;


            config->select_z = (lsb_msb & 0x8000) >> 0x0F;
            ...
            config->threshold = lsb_msb & 0x07FF;
        }
    }
    else
    {
...
static int8_t get_sig_motion_config(struct bmi2_sig_motion_config *config, struct bmi2_dev *dev)
{
    ...
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            config->block_size = lsb_msb & 0xFFFF;
        }
    }
    else
    {
...
static int8_t get_step_config(struct bmi2_step_config *config, struct bmi2_dev *dev)
{
    ...
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            config->watermark_level = lsb_msb & 0x03FF;


            config->reset_counter = (lsb_msb & 0x0400) >> 0x0A;
            ...
            config->step_buffer_size = (lsb_msb & 0xFF00) >> 0x08;
        }
    }
    else
    {
...
static int8_t get_orient_config(struct bmi2_orient_config *config, struct bmi2_dev *dev)
{
    ...
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            config->ud_en = (lsb_msb & 0x0002) >> 0x01;


            config->mode = (lsb_msb & 0x000C) >> 0x02;


            config->blocking = (lsb_msb & 0x0030) >> 0x04;


            config->theta = (lsb_msb & 0x0FC0) >> 0x06;
            ...
            config->hysteresis = lsb_msb & 0x07FF;
        }
    }
    else
    {
...
static int8_t get_high_g_config(struct bmi2_high_g_config *config, struct bmi2_dev *dev)
{
    ...
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            config->threshold = lsb_msb & 0x7FFF;
            ...
            config->hysteresis = lsb_msb & 0x0FFF;


            config->select_x = (lsb_msb & 0x1000) >> 0x0C;


            config->select_y = (lsb_msb & 0x2000) >> 0x0D;


            config->select_z = (lsb_msb & 0x4000) >> 0x0E;
            ...
            config->duration = lsb_msb & 0x0FFF;
        }
    }
    else
    {
...
static int8_t get_flat_config(struct bmi2_flat_config *config, struct bmi2_dev *dev)
{
    ...
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            config->theta = (lsb_msb & 0x007E) >> 0x01;


            config->blocking = (lsb_msb & 0x0180) >> 0x07;
            ...
            config->hysteresis = lsb_msb & 0x003F;


            config->hold_time = (lsb_msb & 0x3FC0) >> 0x06;
        }
    }
    else
    {
...
static int8_t get_high_g_output(uint8_t *high_g_out, struct bmi2_dev *dev)
{
    ...
    feat_found = extract_output_feat_config(&high_g_out_config, 15, dev);
    if (feat_found)
    {
...
static int8_t get_step_counter_output(uint32_t *step_count, struct bmi2_dev *dev)
{
    ...
    feat_found = extract_output_feat_config(&step_cnt_out_config, 7, dev);
    if (feat_found)
    {
...
static int8_t get_nvm_error_status(struct bmi2_nvm_err_status *nvm_err_stat, struct bmi2_dev *dev)
{
    ...
    feat_found = extract_output_feat_config(&nvm_err_cfg, 39, dev);
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            nvm_err_stat->load_error = (feat_config[idx] & (0x01));


            nvm_err_stat->prog_error = ((feat_config[idx] & (0x02)) >> (0x01));


            nvm_err_stat->erase_error = ((feat_config[idx] & (0x04)) >> (0x02));


            nvm_err_stat->exceed_error = ((feat_config[idx] & (0x08)) >> (0x03));


            nvm_err_stat->privil_error = ((feat_config[idx] & (0x10)) >> (0x04));
        }
    }
    else
    {
    ...
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            if (rslt == 0)
            {
                ...
                *status = ((feat_config[idx] & (0x08)) >> (0x03));
            }
        }
    }
    else
...
static int8_t get_step_activity_output(uint8_t *step_act, struct bmi2_dev *dev)
{
    ...
    feat_found = extract_output_feat_config(&step_act_out_config, 8, dev);
    if (feat_found)
    {
...
static int8_t get_orient_output(struct bmi2_orientation_output *orient_out, struct bmi2_dev *dev)
{
    ...
    feat_found = extract_output_feat_config(&orient_out_config, 14, dev);
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            orient_out->portrait_landscape = (feat_config[idx] & (0x03));


            orient_out->faceup_down = ((feat_config[idx] & (0x04)) >> (0x02));
        }
    }
    else
    {
...
static int8_t enable_gyro_gain(uint8_t enable, struct bmi2_dev *dev)
{
    ...
    if (rslt == 0)
    {
        reg_data = ((reg_data & ~(0x80)) | ((enable << 0x07) & 0x80));
...
static int8_t get_vfrm_error_status(struct bmi2_vfrm_err_status *vfrm_err_stat, struct bmi2_dev *dev)
{
    ...
    feat_found = extract_output_feat_config(&vfrm_err_cfg, 40, dev);
    if (feat_found)
    {
        ...
        if (rslt == 0)
        {
            ...
            vfrm_err_stat->lock_error = ((feat_config[idx] & (0x20)) >> (0x05));


            vfrm_err_stat->write_error = ((feat_config[idx] & (0x40)) >> (0x06));


            vfrm_err_stat->fatal_error = ((feat_config[idx] & (0x80)) >> (0x07));
        }
    }
    else
    {
...
static int8_t enable_sensor_features(uint64_t sensor_sel, struct bmi2_dev *dev)
{
    ...
    if (sensor_sel & (1 << 3))
    {
        rslt = set_sig_motion(1, dev);
    }


    if (sensor_sel & (1 << 4))
    {
        rslt = set_any_motion(1, dev);
    }


    if (sensor_sel & (1 << 5))
    {
        rslt = set_no_motion(1, dev);
    }


    if (sensor_sel & (1 << 6))
    {
        rslt = set_step_detector(1, dev);
    }


    if (sensor_sel & (1 << 7))
    {
        rslt = set_step_counter(1, dev);
    }


    if (sensor_sel & (1 << 8))
    {
        rslt = set_step_activity(1, dev);
    }


    if (sensor_sel & (1 << 9))
    {
        rslt = set_gyro_user_gain(1, dev);
    }


    if (sensor_sel & (1 << 25))
    {
        rslt = set_single_tap(1, dev);
    }


    if (sensor_sel & (1 << 26))
    {
        rslt = set_double_tap(1, dev);
    }


    if (sensor_sel & (1 << 27))
    {
        rslt = set_triple_tap(1, dev);
    }


    if (sensor_sel & (1 << 14))
    {
        rslt = set_orientation(1, dev);
    }


    if (sensor_sel & (1 << 15))
    {
        rslt = set_high_g(1, dev);
    }


    if (sensor_sel & (1 << 16))
    {
        rslt = set_low_g(1, dev);
    }
    ...
    if (sensor_sel & ((uint64_t)1 << 34))
    {
        rslt = set_gyro_self_offset_corr(1, dev);
    }
...
static int8_t disable_sensor_features(uint64_t sensor_sel, struct bmi2_dev *dev)
{
    ...
    if (sensor_sel & (1 << 3))
    {
        rslt = set_sig_motion(0, dev);
    }


    if (sensor_sel & (1 << 4))
    {
        rslt = set_any_motion(0, dev);
    }


    if (sensor_sel & (1 << 5))
    {
        rslt = set_no_motion(0, dev);
    }


    if (sensor_sel & (1 << 6))
    {
        rslt = set_step_detector(0, dev);
    }


    if (sensor_sel & (1 << 7))
    {
        rslt = set_step_counter(0, dev);
    }


    if (sensor_sel & (1 << 8))
    {
        rslt = set_step_activity(0, dev);
    }


    if (sensor_sel & (1 << 9))
    {
        rslt = set_gyro_user_gain(0, dev);
    }


    if (sensor_sel & (1 << 25))
    {
        rslt = set_single_tap(0, dev);
    }


    if (sensor_sel & (1 << 26))
    {
        rslt = set_double_tap(0, dev);
    }


    if (sensor_sel & (1 << 27))
    {
        rslt = set_triple_tap(0, dev);
    }


    if (sensor_sel & (1 << 14))
    {
        rslt = set_orientation(0, dev);
    }


    if (sensor_sel & (1 << 15))
    {
        rslt = set_high_g(0, dev);
    }


    if (sensor_sel & (1 << 16))
    {
        rslt = set_low_g(0, dev);
    }
    ...
    if (sensor_sel & ((uint64_t)1 << 34))
    {
        rslt = set_gyro_self_offset_corr(0, dev);
    }
