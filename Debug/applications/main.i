...
# 17 "../applications/main.c" 2
# 1 "../applications/bmi270/bmi270.h" 1
# 47 "../applications/bmi270/bmi270.h"
#define BMI270_H_ 
# 58 "../applications/bmi270/bmi270.h"
...
#define BMI2_DEFS_H_ 
# 50 "C:\\Users\\yaman\\OneDrive\\Documents\\rtthread-workspace\\CH32V208\\applications/bmi270/bmi2_defs.h"
# 1 "c:\\rt-threadstudio\\repo\\extract\\toolchain_support_packages\\wch\\risc-v-gcc-wch\\8.2.0\\lib\\gcc\\riscv-none-embed\\8.2.0\\include\\stddef.h" 1 3 4
...
# 59 "../applications/bmi270/bmi270.h" 2
...
static rt_bool_t initialized = 0;
...
int main(void)
{
    ...
    rt_uint8_t sensor_sel[2] = { 0, 7 };


    struct bmi2_sens_int_config sens_int = { .type = 7, .hw_int_pin = BMI2_INT1 };


    sensor_data.type = 7;

    rt_pin_mode(rt_pin_get("PA.0"),0x00);
    rt_pin_mode(rt_pin_get("PB.4"), 0x02);
    rt_pin_attach_irq(rt_pin_get("PB.4"), 0x01, bmi270_interrupt_cbk, 0);
    rt_pin_irq_enable(rt_pin_get("PB.4"), 0x01);
    ...
    dev.config_file_ptr = 
# 86 "../applications/main.c" 3 4
                         ((void *)0)
# 86 "../applications/main.c"
                             ;
...
rt_int8_t bmi270_i2cx_read(rt_uint8_t reg_addr, rt_uint8_t *reg_data, rt_uint32_t len, void *intf_ptr)
{
    ...
    bmi270_i2cx_write(reg_addr, 
# 156 "../applications/main.c" 3 4
                               ((void *)0)
# 156 "../applications/main.c"
                                   , 0, intf_ptr);
...
static rt_int8_t set_feature_config(struct bmi2_dev *bmi2_dev)
{
    ...
    if (rslt == 0)
    {
        ...
        pin_config.pin_cfg[0].input_en = 0;
        pin_config.pin_cfg[0].lvl = 0;
        pin_config.pin_cfg[0].od = 0;
        pin_config.pin_cfg[0].output_en = 1;
        pin_config.int_latch = 0;
