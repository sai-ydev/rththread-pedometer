...
u8x8_ssd1322_8to32:
.LFB0:
	.file 1 "../packages/u8g2-latest/src/u8x8_d_ssd1322.c"
	.loc 1 94 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L42:
	...
	sw	a5,-24(s0)
.L41:
	.loc 1 394 4 discriminator 1
	li	a1,21
	lw	a0,-36(s0)
	call	u8x8_cad_SendCmd
	.loc 1 395 4 discriminator 1
	lbu	a5,-17(s0)
	mv	a1,a5
	lw	a0,-36(s0)
	call	u8x8_cad_SendArg
	.loc 1 396 4 discriminator 1
	lbu	a5,-17(s0)
	addi	a5,a5,1
	andi	a5,a5,0xff
	mv	a1,a5
	lw	a0,-36(s0)
	call	u8x8_cad_SendArg
	.loc 1 397 4 discriminator 1
	li	a1,92
	lw	a0,-36(s0)
	call	u8x8_cad_SendCmd
	.loc 1 398 4 discriminator 1
	lw	a1,-24(s0)
	lw	a0,-36(s0)
	...
	addi	a5,a5,2
	sb	a5,-17(s0)
	.loc 1 402 4 discriminator 1
	li	a1,21
	lw	a0,-36(s0)
	call	u8x8_cad_SendCmd
	.loc 1 403 4 discriminator 1
	lbu	a5,-17(s0)
	mv	a1,a5
	lw	a0,-36(s0)
	call	u8x8_cad_SendArg
	.loc 1 404 4 discriminator 1
	lbu	a5,-17(s0)
	addi	a5,a5,1
	andi	a5,a5,0xff
	mv	a1,a5
	...
	lw	a0,-36(s0)
	call	u8x8_cad_SendData
	.loc 1 407 8 discriminator 1
	lw	a5,-24(s0)
	addi	a5,a5,4
	sw	a5,-24(s0)
	.loc 1 408 6 discriminator 1
	lbu	a5,-17(s0)
	addi	a5,a5,2
	sb	a5,-17(s0)
...
.LASF927:
	.string	"../packages/u8g2-latest/src/u8x8_d_ssd1322.c"
.LASF213:
