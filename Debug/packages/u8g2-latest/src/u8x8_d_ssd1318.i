# 1 "../packages/u8g2-latest/src/u8x8_d_ssd1318.c"
...
# 1 "<command-line>" 2
# 1 "../packages/u8g2-latest/src/u8x8_d_ssd1318.c"
# 42 "../packages/u8g2-latest/src/u8x8_d_ssd1318.c"
...
# 43 "../packages/u8g2-latest/src/u8x8_d_ssd1318.c" 2
...
static const uint8_t u8x8_d_ssd1318_128x96_icp_init_seq[] = {
  ...
  (21), (0x0d3), (22), (0x000),
  (21), (0x0a2), (22), (0x000),
# 66 "../packages/u8g2-latest/src/u8x8_d_ssd1318.c"
...
static uint8_t u8x8_d_ssd1318_generic(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
# 189 "../packages/u8g2-latest/src/u8x8_d_ssd1318.c"
    case 11:
      if ( arg_int == 0 )
...
# 241 "../packages/u8g2-latest/src/u8x8_d_ssd1318.c"
 arg_int--;
      } while( arg_int > 0 );
