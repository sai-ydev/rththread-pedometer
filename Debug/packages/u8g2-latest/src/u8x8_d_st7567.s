...
.LFB0:
	.file 1 "../packages/u8g2-latest/src/u8x8_d_st7567.c"
	.loc 1 154 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L37:
	...
	sb	a5,-17(s0)
.L47:
	.loc 1 513 2 discriminator 1
	lbu	a5,-17(s0)
	lw	a2,-24(s0)
	mv	a1,a5
	lw	a0,-36(s0)
	call	u8x8_cad_SendData
	.loc 1 514 9 discriminator 1
	lbu	a5,-38(s0)
	addi	a5,a5,-1
	sb	a5,-38(s0)
...
.L82:
	...
	lw	a0,-36(s0)
	call	u8x8_cad_SendData
	.loc 1 704 9 discriminator 1
	lbu	a5,-38(s0)
	addi	a5,a5,-1
	sb	a5,-38(s0)
	.loc 1 705 7 discriminator 1
	lbu	a5,-38(s0)
	bnez	a5,.L82
	.loc 1 707 7
	lw	a0,-36(s0)
...
.LASF936:
	.string	"../packages/u8g2-latest/src/u8x8_d_st7567.c"
.LASF543:
