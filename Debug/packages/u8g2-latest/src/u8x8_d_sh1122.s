...
.LFB0:
	.file 1 "../packages/u8g2-latest/src/u8x8_d_sh1122.c"
	.loc 1 104 1
	.cfi_startproc
	addi	sp,sp,-32
...
.L11:
	...
	lbu	a5,-18(s0)
	bnez	a5,.L12
	.loc 1 173 3 discriminator 2
	lbu	a5,-17(s0)
	addi	a5,a5,1
	sb	a5,-17(s0)
	.loc 1 159 27 discriminator 2
	lbu	a5,-19(s0)
	addi	a5,a5,1
	sb	a5,-19(s0)
.L10:
	.loc 1 159 7 discriminator 1
	lbu	a4,-19(s0)
	li	a5,7
	bleu	a4,a5,.L13
	.loc 1 177 7
...
.LASF919:
	.string	"../packages/u8g2-latest/src/u8x8_d_sh1122.c"
.LASF213:
