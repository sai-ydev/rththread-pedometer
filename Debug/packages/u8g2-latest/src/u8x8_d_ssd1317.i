# 1 "../packages/u8g2-latest/src/u8x8_d_ssd1317.c"
...
# 1 "<command-line>" 2
# 1 "../packages/u8g2-latest/src/u8x8_d_ssd1317.c"
# 42 "../packages/u8g2-latest/src/u8x8_d_ssd1317.c"
...
# 43 "../packages/u8g2-latest/src/u8x8_d_ssd1317.c" 2
...
static uint8_t u8x8_d_ssd1317_generic(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
# 134 "../packages/u8g2-latest/src/u8x8_d_ssd1317.c"
    case 11:
      if ( arg_int == 0 )
...
# 186 "../packages/u8g2-latest/src/u8x8_d_ssd1317.c"
 arg_int--;
      } while( arg_int > 0 );
