# 1 "../packages/u8g2-latest/src/u8x8_cad.c"
...
# 1 "<command-line>" 2
# 1 "../packages/u8g2-latest/src/u8x8_cad.c"
# 86 "../packages/u8g2-latest/src/u8x8_cad.c"
...
# 87 "../packages/u8g2-latest/src/u8x8_cad.c" 2

uint8_t u8x8_cad_SendCmd(u8x8_t *u8x8, uint8_t cmd)
{
  return u8x8->cad_cb(u8x8, 21, cmd, 
# 90 "../packages/u8g2-latest/src/u8x8_cad.c" 3 4
                                                       ((void *)0)
# 90 "../packages/u8g2-latest/src/u8x8_cad.c"
                                                           );
}
...
# 95 "../packages/u8g2-latest/src/u8x8_cad.c" 3 4
                                                       ((void *)0)
# 95 "../packages/u8g2-latest/src/u8x8_cad.c"
                                                           );
}
...
# 102 "../packages/u8g2-latest/src/u8x8_cad.c" 3 4
                                                  ((void *)0)
# 102 "../packages/u8g2-latest/src/u8x8_cad.c"
                                                      );
    cnt--;
  }
  return 1;
...
# 115 "../packages/u8g2-latest/src/u8x8_cad.c" 3 4
                                                           ((void *)0)
# 115 "../packages/u8g2-latest/src/u8x8_cad.c"
                                                               );
}
...
# 120 "../packages/u8g2-latest/src/u8x8_cad.c" 3 4
                                                         ((void *)0)
# 120 "../packages/u8g2-latest/src/u8x8_cad.c"
                                                             );
}
...
void u8x8_cad_vsendf(u8x8_t * u8x8, const char *fmt, va_list va)
{
  ...
  {
    d = (uint8_t)
# 129 "../packages/u8g2-latest/src/u8x8_cad.c" 3 4
                __builtin_va_arg(
# 129 "../packages/u8g2-latest/src/u8x8_cad.c"
                va
# 129 "../packages/u8g2-latest/src/u8x8_cad.c" 3 4
                ,
# 129 "../packages/u8g2-latest/src/u8x8_cad.c"
...
# 144 "../packages/u8g2-latest/src/u8x8_cad.c" 3 4
 __builtin_va_start(
# 144 "../packages/u8g2-latest/src/u8x8_cad.c"
 va
# 144 "../packages/u8g2-latest/src/u8x8_cad.c" 3 4
 ,
# 144 "../packages/u8g2-latest/src/u8x8_cad.c"
...
# 146 "../packages/u8g2-latest/src/u8x8_cad.c" 3 4
 __builtin_va_end(
# 146 "../packages/u8g2-latest/src/u8x8_cad.c"
 va
# 146 "../packages/u8g2-latest/src/u8x8_cad.c" 3 4
 )
# 146 "../packages/u8g2-latest/src/u8x8_cad.c"
...
# 159 "../packages/u8g2-latest/src/u8x8_cad.c"
void u8x8_cad_SendSequence(u8x8_t *u8x8, uint8_t const *data)
{
  uint8_t cmd;
  uint8_t v;
...
# 173 "../packages/u8g2-latest/src/u8x8_cad.c" 3 4
                             ((void *)0)
# 173 "../packages/u8g2-latest/src/u8x8_cad.c"
                                 );
   data++;
   break;
      case 23:
...
# 183 "../packages/u8g2-latest/src/u8x8_cad.c" 3 4
                             ((void *)0)
# 183 "../packages/u8g2-latest/src/u8x8_cad.c"
                                 );
   break;
      case 0x0fe:
   v = *data;
...
# 427 "../packages/u8g2-latest/src/u8x8_cad.c"
...
uint8_t u8x8_cad_ssd13xx_i2c(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
    ...
    case 22:
      ...
      break;
    case 23:
# 462 "../packages/u8g2-latest/src/u8x8_cad.c"
      p = arg_ptr;
       while( arg_int > 24 )
      {
...
uint8_t u8x8_cad_ssd13xx_fast_i2c(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  u8x8_byte_EndTransfer(u8x8);
      ...
      u8x8_byte_SendByte(u8x8, arg_int);
      in_transfer = 1;
# 516 "../packages/u8g2-latest/src/u8x8_cad.c"
      break;
    case 22:
      u8x8_byte_SendByte(u8x8, arg_int);
      break;
    case 23:
      if ( in_transfer != 0 )
 u8x8_byte_EndTransfer(u8x8);
# 532 "../packages/u8g2-latest/src/u8x8_cad.c"
      p = arg_ptr;
       while( arg_int > 24 )
      {
 u8x8_i2c_data_transfer(u8x8, 24, p);
...
uint8_t u8x8_cad_ld7032_i2c(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
 ...
 u8x8_byte_EndTransfer(u8x8);
    ...
    case 22:
      ...
      break;
    case 23:
# 637 "../packages/u8g2-latest/src/u8x8_cad.c"
      p = arg_ptr;
       while( arg_int > 24 )
      {
