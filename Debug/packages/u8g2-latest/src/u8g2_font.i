# 1 "../packages/u8g2-latest/src/u8g2_font.c"
...
# 1 "<command-line>" 2
# 1 "../packages/u8g2-latest/src/u8g2_font.c"
# 36 "../packages/u8g2-latest/src/u8g2_font.c"
# 1 "../packages/u8g2-latest/src/u8g2.h" 1
# 59 "../packages/u8g2-latest/src/u8g2.h"
#define U8G2_H 
...
# 62 "../packages/u8g2-latest/src/u8g2.h" 2
# 97 "../packages/u8g2-latest/src/u8g2.h"
#define U8G2_WITH_HVLINE_SPEED_OPTIMIZATION 
# 106 "../packages/u8g2-latest/src/u8g2.h"
#define U8G2_WITH_INTERSECTION 
# 116 "../packages/u8g2-latest/src/u8g2.h"
...
# 150 "../packages/u8g2-latest/src/u8g2.h"
#define U8G2_WITH_UNICODE 
# 159 "../packages/u8g2-latest/src/u8g2.h"
...
# 189 "../packages/u8g2-latest/src/u8g2.h"
...
# 373 "../packages/u8g2-latest/src/u8g2.h"
...
# 434 "../packages/u8g2-latest/src/u8g2.h"
...
# 1340 "../packages/u8g2-latest/src/u8g2.h"
...
# 37 "../packages/u8g2-latest/src/u8g2_font.c" 2



#define U8G2_FONT_DATA_STRUCT_SIZE 23
# 94 "../packages/u8g2-latest/src/u8g2_font.c"
...
# 111 "../packages/u8g2-latest/src/u8g2_font.c"
...
# 282 "../packages/u8g2-latest/src/u8g2_font.c"
...
# 387 "../packages/u8g2-latest/src/u8g2_font.c"
...
# 442 "../packages/u8g2-latest/src/u8g2_font.c"
    if ( is_foreground )
    {
...
# 519 "../packages/u8g2-latest/src/u8g2_font.c"
...
# 549 "../packages/u8g2-latest/src/u8g2_font.c"
    {
...
# 627 "../packages/u8g2-latest/src/u8g2_font.c"
...
# 670 "../packages/u8g2-latest/src/u8g2_font.c"
 ...
 return font+3;
  ...
  return 
# 711 "../packages/u8g2-latest/src/u8g2_font.c" 3 4
        ((void *)0)
# 711 "../packages/u8g2-latest/src/u8g2_font.c"
            ;
}
...
static u8g2_uint_t u8g2_font_draw_glyph(u8g2_t *u8g2, u8g2_uint_t x, u8g2_uint_t y, uint16_t encoding)
{
  ...
  if ( glyph_data != 
# 722 "../packages/u8g2-latest/src/u8g2_font.c" 3 4
                    ((void *)0) 
# 722 "../packages/u8g2-latest/src/u8g2_font.c"
                         )
  {
...
# 734 "../packages/u8g2-latest/src/u8g2_font.c" 3 4
                                                            ((void *)0) 
# 734 "../packages/u8g2-latest/src/u8g2_font.c"
                                                                 )
    return 1;
  return 0;
}
...
int8_t u8g2_GetGlyphWidth(u8g2_t *u8g2, uint16_t requested_encoding)
{
  ...
  if ( glyph_data == 
# 743 "../packages/u8g2-latest/src/u8g2_font.c" 3 4
                    ((void *)0) 
# 743 "../packages/u8g2-latest/src/u8g2_font.c"
                         )
    return 0;
...
# 763 "../packages/u8g2-latest/src/u8g2_font.c"
void u8g2_SetFontMode(u8g2_t *u8g2, uint8_t is_transparent)
{
...
# 836 "../packages/u8g2-latest/src/u8g2_font.c"
      sum += delta;
    }
  }
  return sum;
...
# 858 "../packages/u8g2-latest/src/u8g2_font.c"
u8g2_uint_t u8g2_DrawUTF8(u8g2_t *u8g2, u8g2_uint_t x, u8g2_uint_t y, const char *str)
{
...
{
  if ( u8g2->font == 
# 975 "../packages/u8g2-latest/src/u8g2_font.c" 3 4
                    ((void *)0) 
# 975 "../packages/u8g2-latest/src/u8g2_font.c"
                         )
    return;
...
# 1101 "../packages/u8g2-latest/src/u8g2_font.c" 3 4
                                               ((void *)0) 
# 1101 "../packages/u8g2-latest/src/u8g2_font.c"
                                                    )
 return 0;
    }
  }
...
static void u8g2_GetGlyphHorizontalProperties(u8g2_t *u8g2, uint16_t requested_encoding, uint8_t *w, int8_t *ox, int8_t *dx)
{
  const uint8_t *glyph_data = u8g2_font_get_glyph_data(u8g2, requested_encoding);
  if ( glyph_data == 
# 1160 "../packages/u8g2-latest/src/u8g2_font.c" 3 4
                    ((void *)0) 
# 1160 "../packages/u8g2-latest/src/u8g2_font.c"
                         )
    return;
...
# 1276 "../packages/u8g2-latest/src/u8g2_font.c"
u8g2_uint_t u8g2_GetUTF8Width(u8g2_t *u8g2, const char *str)
{
  u8g2->u8x8.next_cb = u8x8_utf8_next;
