# 1 "../packages/u8g2-latest/src/u8x8_d_sh1107.c"
...
# 1 "<command-line>" 2
# 1 "../packages/u8g2-latest/src/u8x8_d_sh1107.c"
# 37 "../packages/u8g2-latest/src/u8x8_d_sh1107.c"
...
# 38 "../packages/u8g2-latest/src/u8x8_d_sh1107.c" 2
...
static uint8_t u8x8_d_sh1107_generic(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
# 91 "../packages/u8g2-latest/src/u8x8_d_sh1107.c"
    case 11:
      if ( arg_int == 0 )
...
# 145 "../packages/u8g2-latest/src/u8x8_d_sh1107.c"
 arg_int--;
      } while( arg_int > 0 );
...
# 458 "../packages/u8g2-latest/src/u8x8_d_sh1107.c"
