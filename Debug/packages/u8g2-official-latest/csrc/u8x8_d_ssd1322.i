# 1 "../packages/u8g2-official-latest/csrc/u8x8_d_ssd1322.c"
...
# 1 "<command-line>" 2
# 1 "../packages/u8g2-official-latest/csrc/u8x8_d_ssd1322.c"
# 41 "../packages/u8g2-official-latest/csrc/u8x8_d_ssd1322.c"
...
# 42 "../packages/u8g2-official-latest/csrc/u8x8_d_ssd1322.c" 2
...
# 91 "../packages/u8g2-official-latest/csrc/u8x8_d_ssd1322.c"
...
uint8_t u8x8_d_ssd1322_common(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
# 166 "../packages/u8g2-official-latest/csrc/u8x8_d_ssd1322.c"
    case 11:
      if ( arg_int == 0 )
...
# 439 "../packages/u8g2-official-latest/csrc/u8x8_d_ssd1322.c"
uint8_t u8x8_d_ssd1322_common2(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
# 455 "../packages/u8g2-official-latest/csrc/u8x8_d_ssd1322.c"
    case 11:
      if ( arg_int == 0 )
 u8x8_cad_SendSequence(u8x8, u8x8_d_ssd1322_powersave0_seq);
      else
...
static const uint8_t u8x8_d_ssd1322_128x64_init_seq[] = {
  ...
  (21), (0xa1), (22), (0x00),
  (21), (0xab), (22), (0x01),
# 601 "../packages/u8g2-official-latest/csrc/u8x8_d_ssd1322.c"
