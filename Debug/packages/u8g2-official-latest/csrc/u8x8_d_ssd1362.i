# 1 "../packages/u8g2-official-latest/csrc/u8x8_d_ssd1362.c"
...
# 1 "<command-line>" 2
# 1 "../packages/u8g2-official-latest/csrc/u8x8_d_ssd1362.c"
# 46 "../packages/u8g2-official-latest/csrc/u8x8_d_ssd1362.c"
...
# 47 "../packages/u8g2-official-latest/csrc/u8x8_d_ssd1362.c" 2
...
# 75 "../packages/u8g2-official-latest/csrc/u8x8_d_ssd1362.c"
...
uint8_t u8x8_d_ssd1362_common(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
# 155 "../packages/u8g2-official-latest/csrc/u8x8_d_ssd1362.c"
    case 11:
      if ( arg_int == 0 )
...
uint8_t u8x8_d_ssd1362_common_0_75(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
# 229 "../packages/u8g2-official-latest/csrc/u8x8_d_ssd1362.c"
    case 11:
      if ( arg_int == 0 )
 u8x8_cad_SendSequence(u8x8, u8x8_d_ssd1362_powersave0_seq);
      else
...
static const uint8_t u8x8_d_ssd1362_256x64_init_seq[] = {
  ...
  (21), (0x23), (22), (0x00),
  (21), (0x81), (22), (0x9f),
# 374 "../packages/u8g2-official-latest/csrc/u8x8_d_ssd1362.c"
  (21), (0xa0), (22), (0xc3),
  (21), (0xa1), (22), (0),
  (21), (0xa2), (22), (0),
  (21), (0xa4),
...
static const uint8_t u8x8_d_ssd1362_206x36_init_seq[] = {
  ...
  (21), (0x23), (22), (0x00),
  (21), (0x81), (22), (0x9f),
# 488 "../packages/u8g2-official-latest/csrc/u8x8_d_ssd1362.c"
  (21), (0xa0), (22), (0xc3),
  (21), (0xa1), (22), (50),
  (21), (0xa2), (22), (0),
  (21), (0xa4),
