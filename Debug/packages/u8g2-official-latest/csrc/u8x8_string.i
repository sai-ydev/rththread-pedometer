# 1 "../packages/u8g2-official-latest/csrc/u8x8_string.c"
...
# 1 "<command-line>" 2
# 1 "../packages/u8g2-official-latest/csrc/u8x8_string.c"
# 38 "../packages/u8g2-official-latest/csrc/u8x8_string.c"
...
# 39 "../packages/u8g2-official-latest/csrc/u8x8_string.c" 2
...
uint8_t u8x8_GetStringLineCnt(const char *str)
{
  ...
  uint8_t line_cnt = 1;
  if ( str == 
# 44 "../packages/u8g2-official-latest/csrc/u8x8_string.c" 3 4
             ((void *)0) 
# 44 "../packages/u8g2-official-latest/csrc/u8x8_string.c"
                  )
    return 0;
  for(;;)
  {
...
# 66 "../packages/u8g2-official-latest/csrc/u8x8_string.c"
const char *u8x8_GetStringLineStart(uint8_t line_idx, const char *str )
{
  char e;
  uint8_t line_cnt = 1;
 ...
 return str;
  ...
  return 
# 87 "../packages/u8g2-official-latest/csrc/u8x8_string.c" 3 4
        ((void *)0)
# 87 "../packages/u8g2-official-latest/csrc/u8x8_string.c"
            ;
}
...
{
  if ( dest == 
# 95 "../packages/u8g2-official-latest/csrc/u8x8_string.c" 3 4
              ((void *)0) 
# 95 "../packages/u8g2-official-latest/csrc/u8x8_string.c"
                   )
    return;
  str = u8x8_GetStringLineStart( line_idx, str );
  if ( str != 
# 98 "../packages/u8g2-official-latest/csrc/u8x8_string.c" 3 4
             ((void *)0) 
# 98 "../packages/u8g2-official-latest/csrc/u8x8_string.c"
                  )
  {
    for(;;)
    {
...
# 119 "../packages/u8g2-official-latest/csrc/u8x8_string.c"
uint8_t u8x8_DrawUTF8Line(u8x8_t *u8x8, uint8_t x, uint8_t y, uint8_t w, const char *s)
{
  uint8_t d, lw;
  uint8_t cx, dx;
...
# 159 "../packages/u8g2-official-latest/csrc/u8x8_string.c"
uint8_t u8x8_DrawUTF8Lines(u8x8_t *u8x8, uint8_t x, uint8_t y, uint8_t w, const char *s)
{
  uint8_t i;
  uint8_t cnt;
