# 1 "../packages/u8g2-official-latest/csrc/u8x8_selection_list.c"
...
# 1 "<command-line>" 2
# 1 "../packages/u8g2-official-latest/csrc/u8x8_selection_list.c"
# 38 "../packages/u8g2-official-latest/csrc/u8x8_selection_list.c"
...
# 39 "../packages/u8g2-official-latest/csrc/u8x8_selection_list.c" 2
...
void u8x8_sl_string_line_cb(u8x8_t *u8x8, u8sl_t *u8sl, uint8_t idx, const void *aux)
{
  ...
  if ( s == 
# 108 "../packages/u8g2-official-latest/csrc/u8x8_selection_list.c" 3 4
           ((void *)0) 
# 108 "../packages/u8g2-official-latest/csrc/u8x8_selection_list.c"
                )
    s = "";
  u8x8_DrawUTF8Line(u8x8, u8sl->x, row, ((u8x8)->display_info->tile_width), s);
  (u8x8)->is_font_inverse_mode = (0);
}
# 121 "../packages/u8g2-official-latest/csrc/u8x8_selection_list.c"
uint8_t u8x8_UserInterfaceSelectionList(u8x8_t *u8x8, const char *title, uint8_t start_pos, const char *sl)
{
  u8sl_t u8sl;
  uint8_t event;
  ...
  if ( title != 
# 141 "../packages/u8g2-official-latest/csrc/u8x8_selection_list.c" 3 4
               ((void *)0) 
# 141 "../packages/u8g2-official-latest/csrc/u8x8_selection_list.c"
                    )
  {
